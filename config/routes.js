...
module.exports.routes = {
  ...
  'get /user/register':   { controller: 'auth/Auth',action:'register' },
  'post /user/register':  { controller: 'auth/Auth',action:'signup' },
  'get /auth/login':      { controller: 'auth/Auth',action:'login' },
  'post /auth/login':     { controller: 'auth/Auth',action:'authenticate' },
 
 /* Routes for creating GupShup Topics */
  'get  /api/topics/all':              { controller: 'Forum/GSTopicController', action:'index' },
...
/* Routes for Reply topic */
  'post /topic/reply':             { controller: 'Forum/GSTopicReplyController', action:'replyToTopic' },
